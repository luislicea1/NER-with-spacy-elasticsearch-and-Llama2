...
print(f"Partial Entities: {partial_entities}")
print(f"Missing Entities: {missing_entities}")
print(f"Spurious Entities: {spurious_entities}")


#Precision
precision = (correct_entities + 0.5*partial_entities)/(correct_entities + partial_entities + spurious_entities)
#Recall exhaustividad
recall_detection = (correct_entities + 0.5 * partial_entities)/(correct_entities + partial_entities + missing_entities)
#Puntuacion f1
...
print("____PARA LA DETECCION______")
